...
# brainNo = 'DK39'
filePath = '/home/samik/Keras-FasterRCNN/images/1/'
...
os.system("ls " +  filePath + "*.jp2 | xargs -n 1 basename > listF.txt")
...
f1 = open(os.path.join(jsonOutG, 'DK55_CH3_premotor.csv'), "w")
...
for files in fileList1:
    ...
    f = open(os.path.join(jsonOutG, files.replace('jp2\n', 'json')), "w")
    f.write(
